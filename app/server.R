...
# plot options UI (timeseries & maps)
  ...
  estimationTypeChoices <- reactive({
    estimationTypeChoices <- c(#"Sliding window" = "Cori_slidingWindow", 
                              "14 Day Bagged HPDs, iid bootstrap" = "14_Cori_slidingWindow_legacy", 
                              "14 Day Bagged HPDs" = "14_Cori_slidingWindow", 
                               "14 Day BB w. orig mean" = "14_Cori_slidingWindow_MM", 
                               "14 Day BB w. bagged median" = "14_Cori_slidingWindow_MM_baggedMedian", 
                               "14 Day BB w. bagged mean" = "14_Cori_slidingWindow_MM_baggedMean", 
                              "21 Day Bagged HPDs, iid bootstrap" = "Cori_slidingWindow_legacy", 
                              "21 Day Bagged HPDs" = "Cori_slidingWindow", 
                              "21 Day BB w. orig mean" = "Cori_slidingWindow_MM", 
                              "21 Day BB w. bagged median" = "Cori_slidingWindow_MM_baggedMedian", 
                              "21 Day BB w. bagged mean" = "Cori_slidingWindow_MM_baggedMean", 
                              ...
                              "STEP: 14 Day Bagged HPDs, iid bootstrap" = "14_Cori_step_legacy", 
                              "STEP: 14 Day Bagged HPDs" = "14_Cori_step",
                              "STEP: 14 Day BB w. orig mean" = "14_Cori_step_MM", 
                              "STEP: 14 Day BB w. bagged median" = "14_Cori_step_MM_baggedMedian", 
                              "STEP: 14 Day BB w. bagged mean" = "14_Cori_step_MM_baggedMean" ,
                              "STEP: 21 Day Bagged HPDs, iid bootstrap" = "Cori_step_legacy", 
                              "STEP: 21 Day Bagged HPDs" = "Cori_step",
                               "STEP: 21 Day BB w. orig mean" = "Cori_step_MM", 
                               "STEP: 21 Day BB w. bagged median" = "Cori_step_MM_baggedMedian", 
                               "STEP: 21 Day BB w. bagged mean" = "Cori_step_MM_baggedMean" 
